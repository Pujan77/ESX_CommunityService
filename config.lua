...
Config.Uniforms = {
	prison_wear = {
		male = {
			['tshirt_1'] = {item = 15,texture = 0},

			['torso_1']  ={item = 23,texture = 0},
			['decals_1'] = {item = 0, texutre = 0},
			['arms']     = {item = 119, texture = 0},
			['pants_1']  ={item = 3, texture = 0},
			['pants_2']  = {item = 7, texture = 0},   ['shoes_1']  = {item = 12, texture = 12},
			--['shoes_2']  = {item = 12, texture = 0}, 
			['chain_1']  = 0,
			['chain_2']  = 0
		},
		female = {
